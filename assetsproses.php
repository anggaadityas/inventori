...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $createdBy = $_SESSION['nama']; // Gantilah dengan user session
        ...
        $sqlHeader = "INSERT INTO InventoriAssetHeader 
            (DocNum, DocDate,StoreCode, DocTrans, DocPriority, ApprovalUser, ApprovalUserName,ApprovalProgress, ApprovalStatus, Remarks, CreatedBy,StatusDoc) 
              VALUES (:docNum, :docDate,:StoreCode, :docTrans, :DocPriority, :ApprovalUser, :ApprovalUserName, :ApprovalProgress, :ApprovalStatus, :remarks, :createdBy,:StatusDoc)";
