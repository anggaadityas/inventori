...
$sqlheader = "UPDATE header_returnck SET
    ...
    $stmt = sqlsrv_query( $conn, $sqlheader);
      ...
      foreach($_POST['id_barang'] as $option => $opt){
                          ...
                          rtnitem_qty_verifikasi_good='".htmlspecialchars(addslashes(trim(strip_tags($_POST['qty_good'][$option]))))."',
                           rtnitem_qty_verifikasi_not_good='".htmlspecialchars(addslashes(trim(strip_tags($_POST['qty_notgood'][$option]))))."',
     ...
     {  
          ...
          $body ='Dear Store '.$store_request.' <br><br> 
                       Request Retur Barang <br>dengan No Request  <b>'.$code.' </b> telah dilakukan verifikasi
