...
<form role="form" method="POST" action="reportwasteproses_v1.php">

<span style="font-size:18px;"><b>* Laporan Waste</b></span>
<br><br>


<?php

if($_SESSION["id_divisi"] == 12 || $_SESSION["id_divisi"] == 11 || $_SESSION["role_id"] == 18){
...
?>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Mulai Tanggal Waste</label>
  <input type="text" name="start_date" class="form-control start_date" required readonly>
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1">Akhir Tanggal Waste</label>
