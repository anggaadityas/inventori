...
$sqlid = "SELECT * FROM header_tp where (CONVERT(varchar(20), id_tp)='$ids' OR reqtp_code ='$ids')";
...
$sqlheader = "SELECT *,convert(char(10),reqtp_date,103) req_date,convert(char(10),reqtp_user_verifikasi_date,103) date_verifikasi FROM header_tp a
...
while($x <= 2) {
  ...
  $html .='<table width="100%">
    ...
    <p style="font-size:12px;"><b>FORM TRANSFER PUTUS STORE</b></p>
   <p style="margin-top:-15px;font-size:12px;"><b>'.$rowheader['reqtp_code'].' </b></p>
   </div>
    </td>
    </tr>
  </table>
 ...
 <tr><td width="50px;">Dari Store</td><td>: '.$rowheader['reqtp_destination'].'</td></tr>  
 <tr><td width="20%">Kepada Store</td><td>: '.$rowheader['reqtp_user'].'</td></tr>  
        <tr><td width="20%">Keterangan</td><td>: '.$rowheader['reqtp_note'].'</td></tr> 
  </table>
...
<br><br>';
  ...
  $html .='<table width="100%" class="item"  style="margin-top:20px;">
    ...
    $html .=' <tr>
              ...
              <td align="left">'.htmlspecialchars_decode($rowdetail['tpitem_name']).'</td>
              <td align="left">'.$rowdetail['tpitem_uom'].'</td>
              <td align="left">'.$rowdetail['tpitem_cat'].'</td>
              <td align="left">'.$rowdetail['tpitem_reason'].'</td>
              <td align="left">'.number_format($rowdetail['tpitem_qty_approve'],2,'.',',').'</td>    
