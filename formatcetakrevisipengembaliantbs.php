...
$sqlheader = "SELECT *,convert(char(10),reqtb_destination_retur_verifikasi_date,103) req_retur_verifikasi_date,convert(char(10),reqtb_destination_retur_revisi_date,103) req_retur_rev_date,convert(char(10),reqtb_destination_retur_revisi_verifikasi_date,103) req_retur_rev_verifikasi_date FROM header_tb a
...
if($minus > 0){
$roledestination='<tr><td width="50px;">Dari Store</td><td>: '.$rowheader['reqtb_user'].'</td></tr>  
 <tr><td width="20%">Kepada Store</td><td>: '.$rowheader['reqtb_destination'].'</td></tr>';
$tanggal = ' <tr><td width="45%" style="margin-bottom:10px;">Tanggal Rev Pengembalian</td><td>: '.$rowheader['req_retur_rev_date'].'</td></tr>
        <tr><td width="40%" style="margin-bottom:10px;">Tanggal Verifikasi</td><td>: '.$rowheader['req_retur_rev_verifikasi_date'].'</td></tr>';
        $ttddiberikan ='<p>'.$rowheader['reqtb_user'].'</p>';
        $ttdditerima ='<p>'.$rowheader['reqtb_destination'].'</p>';
}else{
  $roledestination='<tr><td width="50px;">Dari Store</td><td>: '.$rowheader['reqtb_destination'].'</td></tr>  
 <tr><td width="20%">Kepada Store</td><td>: '.$rowheader['reqtb_user'].'</td></tr>';
 $tanggal = ' <tr><td width="45%" style="margin-bottom:10px;">Tanggal Rev Pengembalian</td><td>: '.$rowheader['req_retur_verifikasi_date'].'</td></tr>
        <tr><td width="40%" style="margin-bottom:10px;">Tanggal Verifikasi</td><td>: '.$rowheader['req_retur_rev_date'].'</td></tr>';
        $ttddiberikan ='<p>'.$rowheader['reqtb_destination'].'</p>';
        $ttdditerima ='<p>'.$rowheader['reqtb_user'].'</p>';
}
...
<br>';
  ...
  $html .='<table width="90%" class="item"  style="margin-top:20px;">
    <thead style="background-color: lightgray;">
      <tr>
        <th style="width:3%">No</th>
                ...
                <th align="left" style="width:8%">Jenis Barang</th>
                <th align="left" style="width:10%">Alasan</th>
                <th align="left" style="width:5%">Qty Kelebihan Pengembalian</th>
                <th align="left" style="width:1%">Qty Kekurangan Pengembalian</th>
                <th align="left" style="width:5%">Qty Ver Kelebihan Pengembalian</th>
                <th align="left" style="width:5%">Qty Rev Kekurangan Pengembalian</th>
                <th align="left" style="width:5%">Qty Rev Ver Kekurangan Pengembalian</th>
      </tr>
    </thead>
    <tbody>';


    $sqldetail = "SELECT *,convert(char(10),tbitem_expired_retur,103) expired FROM detail_tb where header_idtb='$id'";
    ...
    while($rowdetail = sqlsrv_fetch_array( $stmtdetail, SQLSRV_FETCH_ASSOC)){
      $fixqtyver =0;
      $fixqtyver = $rowdetail['tbitem_qty_retur_verifikasi'];
      if($fixqtyver == 0){
          $fixqtyverf ="";
      }else{
    ...
    $html .=' <tr>
              ...
              <td align="left">'.$rowdetail['tbitem_qty_retur_verifikasi_plus'].'</td> 
              <td align="left">'.$rowdetail['tbitem_qty_retur_verifikasi_minus'].'</td> 
              <td align="left">'.$rowdetail['tbitem_qty_retur_revisi_plus'].'</td> 
              <td align="left">'.$rowdetail['tbitem_qty_retur_revisi_minus'].'</td> 
              <td align="left">'.$rowdetail['tbitem_qty_retur_revisi_verifikasi_minus'].'</td> 
            </tr>';
