...
<form role="form" method="POST" action="reporttpsproses.php">

<span style="font-size:18px;"><b>* Laporan Transfer Putus Store</b></span>
<br><br>
...
<div class="form-group">
    <label for="exampleInputPassword1">Pilih Report Transfer</label>
