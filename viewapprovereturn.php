...
$id=$_GET['id'];
$sqlheader = "SELECT *,convert(char(10),reqrtn_date,126) req_date,convert(char(10),reqrtn_nodoc_sap_date,126) date_posting,convert(char(10),reqrtn_destination_approve_date,126) date_verifikasi,convert(char(10),reqrtn_destination_arrival_goods_date,126) date_arrival FROM header_returnck a
...
if($rowheader['date_arrival']==''){
    $datearrived=$rowheader['req_date'];
}else{
     $datearrived=$rowheader['date_arrival'];
}
?>
        ...
        <fieldset >
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
                ...
                <div class="col-sm-2">
                <select class="form-control" name="reqrtn_type_req">
            ...
            if($_SESSION['area_div'] == 'CK JAKARTA' OR $_SESSION['area_div']== 'CK SURABAYA'){
             ...
             <?php
                if($rowheader['reqrtn_type_req'] == 1 || $rowheader['reqrtn_type_req'] == 4 ){
             ?>
            <div class="form-group row">
                <label for="inputEmail" class="col-sm-2 col-form-label">No Dokumen SAP</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control kode_sap" name="kode_sap" id="inputEmail" value="<?php echo $rowheader['reqrtn_nodoc_sap']; ?>"  placeholder="Input No Dokumen SAP" autocomplete="off" >
                </div>
            </div>
            <div class="form-group row">
                <label for="inputEmail" class="col-sm-2 col-form-label">Tanggal Posting Dokumen SAP</label>
                <div class="col-sm-3">
                   <input type="text" class="form-control date_posting" name="date_posting" id="date_posting" value="<?php echo $rowheader['date_posting']; ?>" placeholder="Pilih Tanggal Posting SAP"  autocomplete="off" >
                </div>
            </div>
            ...
            OR $_SESSION['area_div'] == 'GA JAKARTA' OR $_SESSION['area_div']== 'GA SURABAYA'
            OR $_SESSION['area_div'] == 'IT JAKARTA' OR $_SESSION['area_div']== 'IT SURABAYA'){
            ?>
...
<!--                     <div class="form-group row">
      ...
      ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                   <input type="text" class="form-control date_verifikasi" name="date_verifikasi" id="date_verifikasi" value="<?php echo $datearrived; ?>" placeholder="Pilih Tanggal Sampai Barang"  autocomplete="off"  required>
                </div>
            </div>
            <!-- <div class="form-group row">
...
<table  class="table table-striped table-bordered dt-responsive nowrap">
                ...
                <tr>
                 ...
                 if($rowheader['reqrtn_destination'] =='ENG JAKARTA' || $rowheader['reqrtn_destination'] == 'ENG SURABAYA'){
                    ...
                    <th rowspan="2">Tanggal Terima Barang Dari CK</th>
                    <th rowspan="2">Keterangan Verifikasi</th>
                    <tr>
                    <th>Bagus</th>
                    <th>Tidak Bagus</th>
...
<?php
        ...
        $sqldetail = "SELECT *,convert(char(10),rtnitem_expired,126) expired,convert(char(10),rtnitem_arrival,126) arrival_date FROM detail_returnck a inner join mst_item b on a.rtnitem_id=b.id_mst_item where header_idrtn='$id' order by rtnitem_cat asc";
        ...
        if($rowdetail['rtnitem_qty_verifikasi_not_good'] ==""){
         ...
         $qtyver =$vergood + $vernotgood;
        $qtyreq = $rowdetail['rtnitem_qty_good']+ $rowdetail['rtnitem_qty_not_good'];
        $selisi = $qtyver - $qtyreq;

        if($rowdetail['kondisi_flag']==1){
            $good="<input type='text' id='qtygood_".$no."' min='0' max='".$rowdetail['rtnitem_qty_good']."' name='qty_good[]' value='".number_format($vergood,2,'.',',')."' style='width:70px' class='form-control qtygood' autocomplete='off' required/><span style='font-size:12px;'><b>Verifikasi</b></span>";
            $notgood="<input type='hidden' id='qtynotgood_".$no."' min='0' max='".$rowdetail['rtnitem_qty_not_good']."' name='qty_notgood[]' value='".number_format($vernotgood,2,'.',',')."' style='width:70px' class='form-control qtynotgood' autocomplete='off'/>";
        }else if($rowdetail['kondisi_flag']==2){
            $good="<input type='hidden' id='qtygood_".$no."' min='0' max='".$rowdetail['rtnitem_qty_good']."' name='qty_good[]' value='".number_format($vergood,2,'.',',')."' style='width:70px' class='form-control qtygood' autocomplete='off'/>";
            $notgood="<input type='text' id='qtynotgood_".$no."' min='0' max='".$rowdetail['rtnitem_qty_not_good']."' name='qty_notgood[]' value='".number_format($vernotgood,2,'.',',')."' style='width:70px' class='form-control qtynotgood' autocomplete='off' required/><span style='font-size:12px;'><b>Verifikasi</b></span>";
        }else{
            ...
            // }else{
                $good="<input type='text' id='qtygood_".$no."' min='0'  name='qty_good[]' value='".number_format($vergood,2,'.',',')."' style='width:70px' class='form-control qtygood' autocomplete='off' required/><span style='font-size:12px;'><b>Verifikasi</b></span>";
                $notgood="<input type='text' id='qtynotgood_".$no."' min='0' name='qty_notgood[]'  value='".number_format($vernotgood,2,'.',',')."' style='width:70px' class='form-control qtynotgood' autocomplete='off' required/><span style='font-size:12px;'><b>Verifikasi</b></span>";
            // }
        }
    ...
    ?>
    <tr>
              <td scope="row"><?php echo $no; ?><input type="hidden" name="id_barang[]" value="<?php echo $rowdetail['rtnitem_id']; ?>"><input type="hidden" name="iddetailretur[]" value="<?php echo $rowdetail['id_detailrtn']; ?>"></td>
              ...
              <?php
                 ...
                 if($rowheader['reqrtn_destination'] =='ENG JAKARTA' || $rowheader['reqrtn_destination'] == 'ENG SURABAYA'){
                  ...
                  <?php echo number_format($rowdetail['rtnitem_qty_good'],2,'.',','); ?>
                  <?php echo $good; ?>
              </td>
               <td align="center">
              <?php echo number_format($rowdetail['rtnitem_qty_not_good'],2,'.',','); ?>
              <?php echo $notgood; ?> 
             </td>
              <td align="left">
              <input type='hidden' id='qtyreq_<?php echo $no; ?>' min="0" max="<?php echo $qtyreq; ?>"  name='qtyreq[]' style='width:70px' value="<?php echo number_format($qtyreq,2,'.',','); ?>" class="form-control qtyreq" autocomplete="off" readonly required/>
              <input type='text' id='qtyverifikasi_<?php echo $no; ?>'  name='qtyverifikasi[]' style='width:70px' value="<?php echo number_format($selisi,2,'.',','); ?>" class="form-control qtyverifikasi" autocomplete="off" readonly required/>
                <input type='hidden' id='qtyverifikasi1_<?php echo $no; ?>'  name='qtyverifikasi1[]' style='width:70px' value="<?php echo number_format($selisi,2,'.',','); ?>" class="form-control qtyverifikasi1" autocomplete="off" readonly required/>
            </td> 
              ...
              <td align="left">
              <input type='hidden' id='qtyreq_<?php echo $no; ?>'  name='qtyreq[]' style='width:70px' value="<?php echo number_format($qtyreq,2,'.',','); ?>" class="form-control qtyreq" autocomplete="off" readonly required/>
              <input type='text' id='qtyverifikasi_<?php echo $no; ?>' name='qtyverifikasi[]' style='width:70px' value="<?php echo $selisi; ?>" class="form-control qtyverifikasi" autocomplete="off" readonly required/>
                <input type='hidden' id='qtyverifikasi1_<?php echo $no; ?>' name='qtyverifikasi1[]' style='width:70px' value="<?php echo number_format($selisi,2,'.',','); ?>" class="form-control qtyverifikasi1" autocomplete="off" readonly required/>
            </td> 
              <td align="left"><?php echo $rowdetail['expired']; ?></td> 
...
var subtotalqty =  parseFloat(totalqty) - parseFloat(qtyreq);
