...
<div class="form-group row">
        ...
        <div class="col-sm-3">
           ...
           <option value="1" selected>Transfer Putus Store</option>
           </select>
        </div>
    </div>
...
<td><input type='number' id='qty_0' name='qty[]' min="1" style='width:70px' class="form-control" autocomplete="off" required/></td>
<td>
  ...
  <div class="form-group row">
        ...
        <fieldset >
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="tanggal_permintaan" id="tanggal_permintaan1" placeholder="Pilh Tanggal Pengambilan" readonly required>
   ...
   <table  class="table table-striped table-bordered dt-responsive nowrap"  id="itemsDetail2">
                ...
                <th>No</th>
                   ...
                   <th  >Kode Barang</th>
                    ...
                    <th>Alasan</th>
                    <th>Jumlah Bagus</th>
                    <th>Jumlah Tidak Bagus</th>
                    <th >Kadaluarsa</th>
                    <th >Kedatangan Barang</th>
                    <th >Keterangan</th>
                </tr>
